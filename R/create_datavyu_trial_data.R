...
#'
#' This was designed to work with datavyu fixation reports and the VWM trial.
...
#' @export
#'
#' @return A formatted dataframe with CP, SwitchRate, MLD and TLT, as well as coding
create_datavyu_trial_data2 <- function(data, write = F){
 ...
 # dvdatanonadj3 <- right_join(dvsubj, nonadj)
  #fix
  dvdatanonadj3 <- nonadj
